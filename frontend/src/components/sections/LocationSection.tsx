        ...
        <section className="relative w-full overflow-hidden" style={{ backgroundColor: "#e8e4de", padding: "60px 0 90px" }} >
            ...
            <div className="relative z-10 flex flex-col items-center" style={{ gap: "32px" }}>
                ...
                <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false, margin: "-80px" }} transition={{ duration: 1.0, ease: [0.25, 1, 0.5, 1] }} className="flex flex-col items-center" style={{ gap: "10px", textAlign: "center", padding: "0 24px" }} >
                    <p style={{ fontFamily: "var(--font-body)", fontSize: "clamp(11px, 2.2vw, 11px)", letterSpacing: "0.25em", textTransform: "uppercase", color: "#8a7a72", fontWeight: 600 }}>
                        {locationSection.eyebrow}
                    </p>
                    <h2 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(34px, 7vw, 38px)", color: "#1a2850", fontWeight: 400, lineHeight: 1.2 }}>
                        {locationSection.title}
                    </h2>
                    <p style={{ fontFamily: "var(--font-handwritten)", fontSize: "clamp(16px, 2.8vw, 13px)", color: "#11212d", fontWeight: 400, lineHeight: 1.6 }}>
                ...
                <motion.p initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false, margin: "-60px" }} transition={{ duration: 0.9, delay: 0.1, ease: [0.25, 1, 0.5, 1] }} style={{ fontFamily: "var(--font-body)", fontSize: "clamp(9px, 2.2vw, 11px)", letterSpacing: "0.25em", textTransform: "uppercase", color: "#8a7a72", fontWeight: 600 }} >
